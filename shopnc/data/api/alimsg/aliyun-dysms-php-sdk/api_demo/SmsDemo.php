...
require_once dirname( '../api_sdk/vendor/autoload.php');
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIglhBTCkYiUpa"; // AccessKeyId

        $accessKeySecret = "zTDnymDbrp6Vz3Sqm4KM0ByemAjzqX"; // AccessKeySecret
    ...
    public static function sendSms($tel/*,$code*/) {
        ...
        $request->setSignName("微商城");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_127167837");
