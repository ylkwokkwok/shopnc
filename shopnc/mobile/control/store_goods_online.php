...
class store_goods_onlineControl extends mobileSellerControl {
    ...
    public function goods_listOp() {
        ...
        //权限组对应分类权限判断
        if (!$this->seller_info['seller_gc_limits'] && $this->seller_group_info['seller_group_id']) {
            $gc_list = Model('seller_group_bclass')->getSellerGroupBclasList(array('group_id'=>$this->seller_group_info['seller_group_id']),'','','gc_id','gc_id');
